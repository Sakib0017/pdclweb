    ...
    <div className="bg-[#F5FFFA]">
      ...
      <div>
        <div className="pt-[150px]  max-w-7xl mx-auto">
          ...
          <div className="  flex-row hidden md:block max-w-7xl mx-auto">
            ...
            <Link to="/about">
              <button className="bg-[#006642] p-2 pl-5 pr-5 w-[200px]  rounded-xl m-5 mx-auto">
                SEE OUR TEAM
              </button>
            </Link>
          </div>
            ...
            <div className="pt-[20px]">
              <div className="flex flex-col  max-w-7xl mx-auto">
                <p className="text-[20px] p-5 me-auto text-gray-500">
                  ...
                  to the people of the country at an affordable cost. This will
                  definitely reduce the burden of the government and will make
                  the path of "Health for all".
                </p>
              </div>
              ...
              <div className="flex flex-row  max-w-7xl   ">
                <div className="me-auto h-auto w-auto">
                  ...
                  <p className="text-gray-500 p-5">
                    ...
                    prestigious diagnostic complexes of Bangladesh which started
                    its activities in 1983. Popular Diagnostic Centre Ltd. is
                    the largest diagnostic services provider organization in
                    private sector of the country. It is been pioneer in
                    introducing world latest medical equipments and advanced
                    technology to provide round the clock medical investigations
                    and consultancy services. LEGAL STATUS Popular Diagnostic
                    Centre Ltd. is a private limited company registered with the
                    Ministry of Health & Family Welfare, People’s Republic Govt.
                    of Bangladesh having License No. 1275 &688 & Trade License
          ...
          <div className="pt-[20px]">
            ...
            <div className="flex flex-wrap max-w-7xl mx-auto">
              ...
              <p className="text-gray-500 p-5">
                ...
                in 1983. Popular Diagnostic Centre Ltd. is the largest
                diagnostic services provider organization in private sector of
                the country. It is been pioneer in introducing world latest
                medical equipments and advanced technology to provide round the
                clock medical investigations and consultancy services. LEGAL
                STATUS Popular Diagnostic Centre Ltd. is a private limited
                company registered with the Ministry of Health & Family Welfare,
                People’s Republic Govt. of Bangladesh having License No. 1275
                &688 & Trade License Number TRAD/DSCC/211718/2019
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="pt-[20px]">
            <div className="flex flex-wrap max-w-7xl mx-auto">
              ...
              <p className="text-gray-500 p-5">
                ...
                the country at an affordable cost and in turn to limit the
