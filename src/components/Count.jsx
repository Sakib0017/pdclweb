...
const Card = ({
  ...
  return (
    <Tilt
        className='mx-auto xs:w-[267px] w-full '
      >
    <motion.div  className='w-full  p-[1px] ' variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      <div
        options={{
          max: 45,
          scale: 1,
      ...
      >
        ...
        <div>
        <h3 className='text-[#006642] text-[32px] ml-3 font-bold text-start font-[Time-New-Romans] '>{description1}</h3>
          <p className=' text-[#006642] text-[16px] ml-3 font-bold text-start font-[Time-New-Romans] '>{name1}</p>
        </div>
