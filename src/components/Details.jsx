...
function Details ({branchPage, onClose}) {
  return (
    <div className="fixed z-50 inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex items-center justify-center">
        <div className="flex flex-col bg-white shadow-2xl rounded-xl mx-5">
          <button onClick={onClose} className="text-black border-solid border-2 rounded-lg font-bold place-self-end p-3">X</button>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 justify-between text-black p-5">
            <div className="justify-center border-solid border-2 border-y-PDCL-green shadow-2xl rounded-lg px-5">
            ...
            <div className="justify-center border-solid border-2 border-y-PDCL-green shadow-2xl rounded-lg">
            ...
            <h1 className="text-center font-bold p-5 font-ubuntu text-[18px] shadow-xl">Location On Map 🗺️📌</h1>
