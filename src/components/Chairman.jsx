              ...
              <div className="flex flex-row  flex-wrap max-w-screen-xl mx-auto  ">
                ...
                <div className="w-auto me-auto items-start justify-start border-opacity-50 pl-2  text-start ml-3">
                  ...
                  <p className="text-gray-900 pt-5">
                    ...
                    that time we established Popular Diagnostic Centre Ltd.<br></br> in
                    ...
                    of our country.<br></br> To meet the demand of the respective doctors
                    we ensured a modern setup of latest high-tech machineries
                    one after another for complete diagnosis of patients with
                    utmost accuracy. Popular Diagnostic is the first private
                    organization which ensured world latest medical equipments
                    and technology in this country. Popular is committed to
                    render the possible standard service to the people of the
                    country at an affordable cost. This will definitely reduce
                    the burden of the government and will make the path of
                    "Health for all" more smooth and effective.
                  </p>
                </div>
              </div>
            </div>
