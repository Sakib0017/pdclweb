...
const Nav = () => {
  ...
  <div className="flex flex-col items-center  justify-center me-auto">
      ...
      <a href=""> 
       ...
       <p onClick={() => navigate('/modal')} className="text-[#006642] justify-center items-center text-[12px] font-small  font-ubuntu">
        <span className="text-[15px] items-center font-ubuntu font-small justify-center">✆</span> 10636(DHANMONDI)</p>  </a> 
        <Link to="/modal"> <a> <p className="text-[#006642] cursor-pointer justify-center items-center text-[10px]   font-ubuntu">OTHER BRANCHES 》</p></a></Link>
      ...
      <Link to="/sample"><p onClick={() => navigate('/')} className="text-[#006642]  items-center flex flex-row text-[12px] mx-auto  font-ubuntu"> 
        ...
        </Popover><a href=""><span className="pl-1 text-[12px] hidden md:block">Home Sample Collection</span></a></p></Link>
