...
const Navbar = () => {
  ...
  <nav className={`${styles.paddingX} w-full  flex items-center shadow fixed top-[33px] z-20 bg-white`} >
 ...
 <Link to="/" >
        ...
        <a> <Link to="/login">      <p className="text-[#006642]  items-center flex flex-row text-[16px] ms-0 me-1 font-medium font-ubuntu"> 
         ...
         <a> <Link to="/health">      <p className="text-[#006642]  items-center flex flex-row text-[16px] ms-0 me-1 font-medium font-ubuntu"> 
         ...
         <a> <Link to="/modal">  <p className="text-[#006642]  items-center flex flex-row text-[16px] ms-0 me-1 font-medium font-ubuntu"> 
         ...
         <div className="flex flex-row  ">
           ...
           <a><Link to="/notice"><p className="text-[#006642]  items-center flex flex-row text-[16px] ms-0 me-1 font-medium font-ubuntu"> 
           ...
           <li className="inline-flex mr-4 flex-row justify-center items-center">
            ...
            <a>  <Link to="/contact"><p className="text-[#006642]  items-center flex flex-row text-[16px] ms-0 me-1 font-medium font-ubuntu"> 
            ...
            <a> <Link to="/about"><p className="text-[#006642]  items-center flex flex-row text-[16px] ms-0 me-1 font-medium font-ubuntu"> 
...
<path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z"></path>
  ...
  <path d="M96 128a128 128 0 1 1 256 0A128 128 0 1 1 96 128zM0 482.3C0 383.8 79.8 304 178.3 304h91.4C368.2 304 448 383.8 448 482.3c0 16.4-13.3 29.7-29.7 29.7H29.7C13.3 512 0 498.7 0 482.3zM504 312V248H440c-13.3 0-24-10.7-24-24s10.7-24 24-24h64V136c0-13.3 10.7-24 24-24s24 10.7 24 24v64h64c13.3 0 24 10.7 24 24s-10.7 24-24 24H552v64c0 13.3-10.7 24-24 24s-24-10.7-24-24z"></path>
        ...
        <a><Link to="/login">      <p className="text-[#006642] me-auto  items-start flex flex-row text-[16px]  font-medium font-ubuntu"> 
         ...
         <a> <Link to="/health">      <p className="text-[#006642] me-auto  items-start flex flex-row text-[16px]  font-bold font-ubuntu"> 
         ...
         <a>  <Link to="/modal">  <p className="text-[#006642] me-auto items-start flex flex-row text-[16px] font-medium font-ubuntu"> 
         ...
         <a> <Link to="/notice"><p className="text-[#006642]  items-center flex flex-row text-[16px]  font-medium font-ubuntu"> 
...
<path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z"></path>
            ...
            <a>  <Link to="/sign"><p className="text-[#006642]  items-center flex flex-row text-[16px] ms-0 me-1 font-medium font-ubuntu"> 
