...
const Navbar = () => {
 ...
 <Link to="/" >
        ...
        <a> <Link to="/report">   <p className="text-emerald-900/80  items-center flex flex-row text-[20px] ms-0 me-1 font-medium font-ubuntu"> 
         ...
         <a> <Link to="/health">      <p className="text-emerald-900/80  items-center flex flex-row text-[20px] ms-0 me-1 font-medium font-ubuntu"> 
           ...
           <a href=""> <span className="pl-1 text-[20px] font-medium font-ubuntu hidden md:block">Packages</span></a></p>
                 </Link></a>
           </div>
         ...
         <span className="pl-1 text-[20px] font-medium font-ubuntu hidden md:block cursor-pointer">Branches</span>
          </p>
          </Link>    </a> 
      </PopoverHandler>
         ...
         <div className="flex flex-row  ">
           ...
           <a href=""><span className="pl-1  text-[20px] font-medium font-ubuntu hidden md:block">Notice</span></a></p>
           </Link>         
           </a>          
           ...
           <li className="inline-flex mr-4 flex-row justify-center items-center">
            ...
            <a>  <Link to="/contact"><p className="text-emerald-900/80  items-center flex flex-row text-[20px] ms-0 me-1 font-medium font-ubuntu"> 
              ...
              <a href=""><span className="pl-1  text-[20px] font-medium font-ubuntu hidden md:block">Contact</span></a></p>
              </Link>         
              </a>          
            ...
            <a> <Link to="/about"><p className="text-emerald-900/80  items-center flex flex-row text-[20px] ms-0 me-1 font-medium font-ubuntu"> 
              ...
              <a href=""><span className="pl-1  text-[20px] font-medium font-ubuntu hidden md:block">About Us</span></a></p>
              </Link>         
              </a>        
...
<path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z"></path>
              ...
              <span className="text-emerald-900/80 hover:text-[#000000] text-[20px] ms-0 mx-auto  font-medium font-ubuntu">Login</span>
      </p></Link></a><br />
  ...
  <path d="M96 128a128 128 0 1 1 256 0A128 128 0 1 1 96 128zM0 482.3C0 383.8 79.8 304 178.3 304h91.4C368.2 304 448 383.8 448 482.3c0 16.4-13.3 29.7-29.7 29.7H29.7C13.3 512 0 498.7 0 482.3zM504 312V248H440c-13.3 0-24-10.7-24-24s10.7-24 24-24h64V136c0-13.3 10.7-24 24-24s24 10.7 24 24v64h64c13.3 0 24 10.7 24 24s-10.7 24-24 24H552v64c0 13.3-10.7 24-24 24s-24-10.7-24-24z"></path>
              ...
              <span className="text-emerald-900/80 hover:text-[#000000] text-[20px] ms-0 mx-auto font-medium font-ubuntu">Register</span>
      </p></Link></a>
           </PopoverContent>
        </Popover>
...
<path d="M0 96C0 78.3 14.3 64 32 64H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 128 0 113.7 0 96zM64 256c0-17.7 14.3-32 32-32H480c17.7 0 32 14.3 32 32s-14.3 32-32 32H96c-17.7 0-32-14.3-32-32zM448 416c0 17.7-14.3 32-32 32H32c-17.7 0-32-14.3-32-32s14.3-32 32-32H416c17.7 0 32 14.3 32 32z"></path>
        ...
        <a><Link to="/login">      <p className="text-white me-auto  items-start flex flex-row text-[20px]  font-medium font-ubuntu"> 
           ...
           <a href=""> <span className=" me-auto text-[20px] font-medium font-ubuntu ">Pataint Portal</span></a></p>
                 </Link></a>
           </div>
         ...
         <a> <Link to="/health">      <p className="text-white me-auto  items-start flex flex-row text-[20px]  font-medium font-ubuntu"> 
           
            
           
           <a href=""> <span className="me-auto text-[20px] font-medium font-ubuntu">Packages</span></a></p>
                 </Link></a>
           </div>
         ...
         <a>  <Link to="/modal">  <p className="text-white me-auto items-start flex flex-row text-[20px] font-medium font-ubuntu"> 
                 ...
                 <a href=""> <span className="text-[20px] font-medium font-ubuntu ">Branches</span></a></p>
                 </Link></a>
           </div>
         ...
         <a> <Link to="/notice"><p className="text-white  items-center flex flex-row text-[20px]  font-medium font-ubuntu"> 
           ...
           <a href=""><span className="text-[20px] font-medium font-ubuntu ">Notice</span></a></p>
           </Link>      </a>   
           ...
           <li className="inline-flex flex-row justify-start items-start">
            ...
            <a>  <Link to="/contact"><p className="text-white  items-center flex flex-row text-[20px] ms-0 me-1 font-medium font-ubuntu"> 
              ...
              <a href=""><span className="text-[20px] font-medium font-ubuntu ">Contact</span></a></p>
              </Link>   </a>      
            ...
            <a>  <Link to="/about"><p className="text-white  items-center flex flex-row text-[20px] ms-0 me-1 font-medium font-ubuntu"> 
              ...
              <a href=""><span className="text-[20px] font-medium font-ubuntu ">About Us</span></a></p>
              </Link>    </a>     
...
<path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z"></path>
              ...
              <a href=""><span className="text-[20px] pl-2 font-medium font-ubuntu ">Login</span></a></p>
              </Link>  </a>       
...
<path d="M96 128a128 128 0 1 1 256 0A128 128 0 1 1 96 128zM0 482.3C0 383.8 79.8 304 178.3 304h91.4C368.2 304 448 383.8 448 482.3c0 16.4-13.3 29.7-29.7 29.7H29.7C13.3 512 0 498.7 0 482.3zM504 312V248H440c-13.3 0-24-10.7-24-24s10.7-24 24-24h64V136c0-13.3 10.7-24 24-24s24 10.7 24 24v64h64c13.3 0 24 10.7 24 24s-10.7 24-24 24H552v64c0 13.3-10.7 24-24 24s-24-10.7-24-24z"></path>
              ...
              <a href=""><span className="text-[20px] pl-1 font-medium font-ubuntu ">Register</span></a></p>
              </Link> </a>        
