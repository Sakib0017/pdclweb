...
const FeedbackCard = ({
  ...
  >
    ...
    <img
        ...
        <svg class="w-[30px] h-[30px] fill-gray-500" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
      ...
      <p className='text-gray-500 font-ubuntu  font-medium text-[16px]'>{testimonial}</p>
      <svg class="w-[30px] h-[30px] fill-gray-500" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
