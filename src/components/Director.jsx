            ...
            <div className="flex flex-row  flex-wrap max-w-screen-xl mx-auto  ">
              ...
              <div className="w-auto me-auto items-start justify-start border-opacity-50 pl-2  text-start ml-3">
                ...
                <p className="text-gray-900 pt-5">
                  ...
                  Diagnostic.<br></br> Bangladesh is a developing country. We have
                  tremendous scope and potentiality in our industry especially
                  in health sector. Basically my father was a Doctor. None of my
                  family members were engaged in business. My dream was to be a
                  surgeon. But necessity and circumstances force me to start
                  diagnostic business. Challenges and problems are many. But
                  solving strategies are very few and precise. As a businessman
                  we should relentlessly concern about our commitment and
                  quality.<br></br> To achieve the goal and ensure the quality service
                  need highly skilled manpower who will continue to produce high
                  ...
                  provider organization I always concern to ensure the right man
                  in the right place. I believe that if a person whether he is a
                  doctor or not works hard, has merit, good behaviour and
                  remains honest, he will be a successful businessman. Success
                  is nothing but a goal of achievement. In an every success has
                  positive productivity, which is dedicated for the welfare of
                  mankind. Almighty God, Honorable Doctors and my beloved
                  colleagues are always inspired me to do good and take
                  challenges. My all afford to happy them..
                </p>
              </div>
            </div>
          </div>
